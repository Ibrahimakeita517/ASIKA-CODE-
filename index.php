...
<main class="min-h-screen bg-orion-dark flex flex-col items-center justify-center text-white px-4 relative overflow-hidden">
    <!-- Glow Effect -->
    <div class="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[500px] h-[500px] bg-orion-orange/20 rounded-full blur-[120px]"></div>

    <!-- Logo Section -->
    <div class="z-10 text-center mb-12">
        <div class="w-20 h-20 bg-orion-orange rounded-2xl mx-auto flex items-center justify-center mb-6 shadow-lg shadow-orion-orange/20">
            <!-- Simple SVG Icon representing Orion -->
            <svg class="w-12 h-12 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13 10V3L4 14h7v7l9-11h-7z"></path>
            </svg>
        </div>
        <h1 class="text-4xl font-extrabold tracking-tight mb-2">CODE <span class="text-orion-orange">ORION</span> LABS</h1>
    ...
    <div class="z-10 w-full max-w-xs space-y-4">
        <a href="login.php" class="block w-full bg-orion-orange hover:bg-orange-600 text-white font-bold py-4 rounded-2xl text-center transition-all shadow-lg shadow-orion-orange/30">
